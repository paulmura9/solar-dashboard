...
export default function ElevationView({ elevationAngle }: ElevationViewProps) {
  // servo 90 = horizontal (0° tilt), servo 0 = pointing up (-90°), servo 180 = pointing down (90°)
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      >
        ...
        {/* Panel group rotated around mount point */}
